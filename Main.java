...
class DigitalLibraryManagement {
    ...
    public void admin_login() {
        ...
        loginto.put("Swapnil", 12345);
        loginto.put("Ware", 23456);
    ...
    public void user_login() {
        ...
        System.out.print("Enter Password: ");
        int password = sc.nextInt();
        loginto.put("Tejal", 22222);
        loginto.put("Swapnil", 20026);
        loginto.put("Anubhav", 12345);
        loginto.put("anu", 24680);
        loginto.put("Harshal", 11111);
